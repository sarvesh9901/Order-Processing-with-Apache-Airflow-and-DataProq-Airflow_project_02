...
def main(date):
    ...
    #my_airflow_projects/my_airflow_project_02/spark-job
    input_path = f"gs://my_airflow_projects/my_airflow_project_02/data/orders_{date}.csv"
    ...
    output_path = f"gs://my_airflow_projects/my_airflow_project_02/output/processed_orders_{date}"
